    ...
    For i = 2 To derLigneVisites
        ...
        If guidesAutorises.Count > 0 Then
            ...
            If Not GuideDejaOccupe(guideAssigne, dateVisite, derLignePlanning - 1) Then
                ...
                wsPlanning.Cells(derLignePlanning, 4).Value = musee ' Musee (col 4)
                wsPlanning.Cells(derLignePlanning, 5).Value = typeVisite ' Type_Visite (col 5)
                wsPlanning.Cells(derLignePlanning, 6).Value = wsVisites.Cells(i, 14).Value ' Duree (col 6)
                wsPlanning.Cells(derLignePlanning, 7).Value = guideAssigne ' Guide_Attribue (col 7)
                wsPlanning.Cells(derLignePlanning, 8).Value = wsVisites.Cells(i, 9).Value ' Theme (col H/8) - INVERSE
                wsPlanning.Cells(derLignePlanning, 9).Value = wsVisites.Cells(i, 8).Value ' Niveau (col I/9) - INVERSE
            ...
            Else
                ...
                If trouve Then
                    ...
                    wsPlanning.Cells(derLignePlanning, 6).Value = wsVisites.Cells(i, 14).Value ' Duree (col 6)
                    wsPlanning.Cells(derLignePlanning, 7).Value = guideAssigne ' Guide_Attribue (col 7)
                    wsPlanning.Cells(derLignePlanning, 8).Value = wsVisites.Cells(i, 9).Value ' Theme (col H/8)
                ...
                Else
                    ...
                    wsPlanning.Cells(derLignePlanning, 5).Value = typeVisite ' Type_Visite (col 5)
                    wsPlanning.Cells(derLignePlanning, 6).Value = wsVisites.Cells(i, 14).Value ' Duree (col 6)
                    wsPlanning.Cells(derLignePlanning, 7).Value = "NON ATTRIBUE" ' Guide_Attribue (col 7)
                    wsPlanning.Cells(derLignePlanning, 8).Value = wsVisites.Cells(i, 9).Value ' Theme (col H/8)
                    wsPlanning.Cells(derLignePlanning, 9).Value = wsVisites.Cells(i, 8).Value ' Niveau (col I/9)
...
Private Function GuideDejaOccupe(guideID As String, dateVisite As Date, derniereLigne As Long) As Boolean
    ...
    For i = 2 To derniereLigne
        On Error Resume Next
        If wsPlanning.Cells(i, 7).Value = guideID Then ' Guide_Attribue (col 7)
...
Public Sub ModifierAttribution()
    ...
    Dim msg As String
    msg = "Visite : " & wsPlanning.Cells(ligneVisite, 4).Value & vbCrLf ' Musee (col 4)
    ...
    msg = msg & "Guide actuellement assigne : " & wsPlanning.Cells(ligneVisite, 7).Value ' Guide_Attribue (col 7)
    ...
    ' Mettre a jour
    wsPlanning.Cells(ligneVisite, 7).Value = nouveauGuide ' Guide_Attribue (col 7)
    wsPlanning.Cells(ligneVisite, 11).Value = "Modifie manuellement le " & Format(Now, "dd/mm/yyyy hh:nn") ' Statut (col 11)
